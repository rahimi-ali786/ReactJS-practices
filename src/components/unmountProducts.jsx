...
import UnmountProduct from './unmountProduct';
import ProductContext from '../context/contextProducts';

class UnmountProducts extends Component {
  ...
  return (
       <>
         ...
         {this.context.products.map((p, index) => (
            <UnmountProduct key={index} productName={p.productName} count= {p.count} id={p.id}>
                <p>
...
export default UnmountProducts;